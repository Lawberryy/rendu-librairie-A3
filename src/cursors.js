 ...
 */
  ...
  function setCursor(type, color = "#000000", size = 32) {
    ...
    if (type == "heart") {
        ...
        //const svg = créer un svg de coeur avec la couleur et la taille qui est en param
    ...
    let svg_url = 'url("data:image/svg+xml;utf8,' + encodeURIComponent(svg_star) + '") 10 10, auto';
    ...
    if (data == "rocket") {
        ...
        //const svg = créer en svg de coeur avec la couleur et la taille qui est en param
